...
#include "blupyInteractiveTool.generated.h"


/**
 * Builder for UblupyInteractiveTool
 */
UCLASS()
class BLUPY_API UblupyInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UblupyInteractiveTool
 */
UCLASS(Transient)
class BLUPY_API UblupyInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UblupyInteractiveToolProperties();
...
/**
 * UblupyInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class BLUPY_API UblupyInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UblupyInteractiveToolProperties> Properties;
