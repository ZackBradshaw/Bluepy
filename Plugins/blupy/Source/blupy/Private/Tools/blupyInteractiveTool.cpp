...
#include "blupyInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UblupyInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UblupyInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UblupyInteractiveTool* NewTool = NewObject<UblupyInteractiveTool>(SceneState.ToolManager);
...
UblupyInteractiveToolProperties::UblupyInteractiveToolProperties()
{
...
void UblupyInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UblupyInteractiveTool::Setup()
{
	...
	Properties = NewObject<UblupyInteractiveToolProperties>(this, "Measurement");
...
void UblupyInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UblupyInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UblupyInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UblupyInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UblupyInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UblupyInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UblupyInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UblupyInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UblupyInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
